...
RED.workspaces = (function() {
            ...
            buttons: [
                {
                    ...
                    class: 'leftButton'+((getWorkspaceCount() == 1)?" disabled":""),
    ...
    function createWorkspaceTabs() {
        workspace_tabs = RED.tabs.create({
            ...
            onadd: function(tab) {
                ...
                RED.menu.setDisabled("menu-item-workspace-delete",getWorkspaceCount() <= 1);
                if (getWorkspaceCount() === 1) {
                    showWorkspace();
                }
            },
    ...
    return {
        ...
        count: function(includeSubflows) {
            if(includeSubflows){
                console.log('Workspace Count(incl.sub):', workspace_tabs.count());
                return workspace_tabs.count();
            }
            var wsCount = getWorkspaceCount();
            console.log('Workspace Count:', wsCount);
            return wsCount;
        },
        active: function() {
...
function getWorkspaceCount() {
    var wsCount = 0;
    RED.nodes.eachWorkspace(function (w) { console.log(w.id); wsCount++; });
    return wsCount;
}
